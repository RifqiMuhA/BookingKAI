...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (!email.trim()) {
      setErrorMessage("Silakan masukkan email atau nomor telepon Anda.");
      return;
    }
    if (!password) {
    ...
    // Cek apakah akun ini pernah didaftarkan di halaman register
    let userName = email.split("@")[0] || "Pengguna KAI";
    try {
